...
public class LoginForma extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Zika");

        jPasswordField1.setText("z1");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        KlijentskiZahtev kz=new KlijentskiZahtev(operacije.Operacije.login, (User)u);
        komunikacija.Komunikacija.getInstance().posaljiZahtev(kz);
        u=(User) komunikacija.Komunikacija.getInstance().primiOdgovor().getOdgovor();
        if(u==null){
            JOptionPane.showMessageDialog(this, "greska, user je vec ulogovan");
            return;
        }
        if(u.getId()==-3){
            JOptionPane.showMessageDialog(this, "greska, vec je 5 usera ulogovano");
            return;
        }
        if(u.getId()!=-1){
            ...
            JOptionPane.showMessageDialog(this, "pogresan username ili password");
        }
